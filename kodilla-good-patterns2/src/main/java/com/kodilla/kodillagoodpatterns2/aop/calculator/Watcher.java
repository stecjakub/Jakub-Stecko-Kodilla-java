package com.kodilla.kodillagoodpatterns2.aop.calculator;
...
public class Watcher {
    ...
    @Before("execution(* com.kodilla.kodillagoodpatterns2..aop.calculator.Calculator.factorial(..))" +
    ...
    @Around("execution(* com.kodilla.kodillagoodpatterns2.aop.calculator.Calculator.factorial(..))")
