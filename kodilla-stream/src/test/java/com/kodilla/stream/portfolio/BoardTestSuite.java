...
public class BoardTestSuite {
    ...
    void testAddTaskListAverageWorkingOnTask(){
        ...
        double averageWorkingOnTask = project.getTaskLists().stream().filter(inProgressTasks::contains).flatMap(tl->tl.getTasks().stream()).mapToDouble(t-> Period.between(t.getCreated(),LocalDate.now()).getDays()).average().getAsDouble();
        System.out.println(averageWorkingOnTask);
